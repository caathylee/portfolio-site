        ...
        <div id="resume-content">
          <div className="row">
                ...
                <h4 className="list-heading baby-blue">EDUCATION</h4>
                  <h5 className="school-name">Hack Reactor</h5>
                    <ul className="left-column-list">
                      ...
                      <li>Software Engineer Immersive Program</li>
            ...
            <div className="col-md-8">
              ...
              <h5 className="list-sub-heading"><span className="bold">ShareCrow |</span> <span className="light">Software Engineer |</span> <a className="resume-links golden-yellow light" href="http://sharecrow.org/">sharecrow.org</a></h5>
