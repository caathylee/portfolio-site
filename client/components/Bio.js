        ...
        <div id="bio">
          ...
          <div className="row">
            ...
            <div className="col-md-6" id="bio-content">
              ...
              <p className="bio-paragraph">Outside of career, my personal interests include cooking, spin class, playing video games & board games, hiking with my dog, <a className="baby-blue about-link"href="https://www.instagram.com/pudgethemightycorgi/">@pudgethemightcorgi</a>, attending the occasional nerdy convention, and traveling.</p>
            </div>
          </div>
        </div>
        <Footer />
